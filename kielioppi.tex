...
jolloin näistä pääsanan on oltava \textbf{-'e'}-sijamuodossa.

\begin{tabular}{l l}
    jagh \textbf{jeybogh} SuvwI''e' & vihollisen voittanut soturi \\
...
\begin{tabular}{Bl Il | Bl Il}
    ...
    po' & olla taitava & powI' & asiantuntija \\
...
Demonstratiivipronomini \textbf{latlh} merkitsee \textit{toinen}.
\index{demonstratiivipronomini}
...
\begin{tabular}{l l}
    ...
    yInlu' \textbf{'e'} toblu'. & Todistetaan, että eletään. \\
\end{tabular}
...
Poikkeuksellisesti adverbit \textbf{je} \textit{myös}, \textbf{neH} \textit{vain} ja \textbf{jay'} sijoitetaan lauseen loppuun.

esimerkkejä\dots

\textbf{je} ja \textbf{neH} voivat toimia myös adjektiivin tavoin substantiivin määreinä.
