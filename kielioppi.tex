...
\begin{quote}
    Iikka Hauhio \\
    \textit{Helsingissä syyskuussa 2020}
\end{quote}
...
\begin{quote}
    'Iyqa' HawHI'o' \\
    \textit{HelsIngqI'Daq, tera' jar Hut, tera' DIS 2020}
\end{quote}
...
Tällöin verbillä voi olla vain päätteet \textbf{-Ha'}, \textbf{-be'} ja \textbf{-qu'}. [Onko varmasti näin?]\\*[1em]
\begin{tabular}{l l}
...
On aina sallittua käyttää teelisten päätteiden sijasta yleisiä päätteitä.\\*[1em]
\begin{tabular}{l l}
...
Ei ole selvää, milloin \textbf{-ghach}-johdinta tarvitaan, sillä monet verbit sellaisenaan ovat substantiiveja ilman johdinta.\\*[1em]
\begin{tabular}{Bl Il | Bl Il}
...
Poikkeuksellisesti adverbit \textbf{je} \textit{myös}, \textbf{neH} \textit{vain} sijoitetaan predikaatin jälkeen.\\*[1em]
\begin{tabular}{l l}
...
\textbf{je} ja \textbf{neH} voivat toimia myös adjektiivin tavoin substantiivin tai pronominin määreinä.\\*[1em]
\begin{tabular}{l l}
...
a b ch D e gh H I j l m n ng o p q Q r S t tlh u v w y ' \\*[1em]
